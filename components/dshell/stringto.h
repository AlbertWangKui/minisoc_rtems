 ...
 *         source of the error.
 */
OspStatusCode_e drv_rtems_string_to_unsigned_char(
  const char     *s,
  unsigned char  *n,
  char          **endptr,
  int             base
 ...
 *         source of the error.
 */
OspStatusCode_e drv_rtems_string_to_int(
  const char  *s,
  int         *n,
  char       **endptr,
  int          base
 ...
 *         source of the error.
 */
OspStatusCode_e drv_rtems_string_to_unsigned_int(
  const char    *s,
  unsigned int  *n,
  char         **endptr,
  int            base
 ...
 *         source of the error.
 */
OspStatusCode_e drv_rtems_string_to_long(
  const char  *s,
  long        *n,
  char       **endptr,
  int          base
 ...
 *         source of the error.
 */
OspStatusCode_e drv_rtems_string_to_long_long(
  const char  *s,
  long long   *n,
  char       **endptr,
  int          base
 ...
 *         source of the error.
 */
OspStatusCode_e drv_rtems_string_to_unsigned_long_long(
  const char           *s,
 ...
 *         source of the error.
 */
OspStatusCode_e drv_rtems_string_to_float(
  const char   *s,
  float        *n,
  char        **endptr
);
 ...
 *         source of the error.
 */
OspStatusCode_e drv_rtems_string_to_double(
  const char   *s,
  double       *n,
  char        **endptr
);
 ...
 *         source of the error.
 */
OspStatusCode_e drv_rtems_string_to_long_double(
  const char   *s,
  long double  *n,
  char        **endptr
);
