...
#define WATCHDOG_RST_ENABLE_BIT       (1)           ///< Reset enable bit position
#define WATCHDOG_INT_ENABLE_BIT       (0)           ///< Interrupt enable bit position
...
typedef struct WdtDrvData {
    ...
    U32           clkHz;           ///< Watchdog clock frequency in Hz
    U32           workMode;       ///< Watchdog current work mode
    bool          triggered;      ///< Watchdog triggered flag
} WdtDrvData_s;
